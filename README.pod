...
This fork is an attempt to add XFT support, and optional borders around the bar, to the upstream Lemonbar. Other XFT patched forks are based on older Lemonbar releases
